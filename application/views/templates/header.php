        ...
        <div class="modal-content">
            ...
            <form id="form_insript">
                <div class="modal-body">
                    ...
                    <div id="pb_pwd2" style="color:red;visibility:hidden;"><i></i></div>Confirmation mot de passe<input type="password" id="pwd2_form" name="confirmepassword" class="form-control" required><br>
                </div>
